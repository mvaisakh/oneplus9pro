...
//********************************************************************************
UINT32	Freq_Convert( long SfFreq )
{
	UINT32	UlPhsStep;
	
	UlPhsStep	= ( UINT32 )( ( SfFreq * ( long )0x100000000 / FS_FREQ + 0.5F ) / 2.0F ) ;
...
//	SfTmp	= StFRAParam.StHostCom.SfAmpCom.SfFltVal / 1400.0F ;									// AVDD 2800mV / 2 = 1400mV
	...
	RamWrite32A( SinWave_Gain,		( UINT32 )( ( long )0x7FFFFFFF * SfTmp ) ) ;					// Set Sine Wave Gain
