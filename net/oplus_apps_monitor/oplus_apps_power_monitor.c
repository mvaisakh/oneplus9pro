...
void oplus_app_monitor_update_app_info(void *data, struct sock *sk,
...
void oplus_app_power_monitor_init(void)
{
    ...
    ret = register_trace_android_vh_oplus_app_monitor_update(oplus_app_monitor_update_app_info, NULL);
    if(ret){
       pr_err("[app_monitor]:register_trace_android_vh_oplus_app_monitor failed! ret=%d\n", ret);
       return;
    }
	report_timer_init();
...
{
    unregister_trace_android_vh_oplus_app_monitor_update(oplus_app_monitor_update_app_info, NULL);
	report_timer_del();
	oplus_app_monitor_stop();
