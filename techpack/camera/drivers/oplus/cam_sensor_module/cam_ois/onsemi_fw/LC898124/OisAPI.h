...
extern UINT8 SetAngleCorrection124( long DegreeGap, UINT8 SelectAct, unsigned char Arrangement );
...
extern UINT32	TneZeroServo( UINT8 , long );			/* zero servo adjustment command */
